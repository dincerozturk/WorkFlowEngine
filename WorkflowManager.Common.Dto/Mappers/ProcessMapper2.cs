...
namespace WorkFlowManager.Common.Mappers
{
    ...
    {
        public T ToProcess<T>(ProcessForm formData) where T : Process
        {
        ...
        public ProcessForm ToProcessForm(this Process process, IEnumerable<Process> mainProcessList, IEnumerable<DecisionMethod> decisionMethodList, IEnumerable<FormView> formViewList)
        {
