...
namespace WorkFlowManager.Services.DbServices
{
    public class WorkFlowService : IWorkFlowService
    {
        ...
        public IEnumerable<WorkFlowManager.Common.Tables.Task> GetTaskList()
        {
            return _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>()
        ...
        {
            var gorev = _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>().Get(gorevId);
        ...
        public string Delete(int processId)
        {
            ...
            WorkFlowManager.Common.Tables.Task task = _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>().Get(process.TaskId);
            if (task.StartingProcessId == process.Id)
            {
                task.StartingProcessId = null;
                _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>().Update(task);
                _unitOfWork.Complete();
            }
        ...
        {
            var newTask = new WorkFlowManager.Common.Tables.Task()
            {
            ...
            _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>().Add(newTask);
            _unitOfWork.Complete();
            return newTask.Id;
        }
        ...
        {
            WorkFlowManager.Common.Tables.Task task = _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>().Get(taskId);
