...
namespace WorkFlowManager.Common.Constants
{
    public class WorkFlowUtil : IWorkFlowUtil
    {
        ...
        private string SubProcessDiagram(string processUniqueId, string name)
        {
        ...
        public void SetWorkFlowDiagram(IUnitOfWork _unitOfWork, int taskId)
        {
            ...
            var task = _unitOfWork.Repository<Tables.Task>().Get(x => x.Id == taskId);
        ...
        public void SetWorkFlowDiagram(int taskId)
        {
            ...
            var subProcessList = new Dictionary<string, string>();
            var task = _unitOfWork.Repository<WorkFlowManager.Common.Tables.Task>().Get(x => x.Id == taskId);
            string workFlowDiagram = "";
            StringBuilder resultDiagram = new StringBuilder();
