...
namespace WorkFlowManager.Common.DataAccess._Context
{
    ...
    {
        public DataContext() : base("Data Source =.; Initial Catalog = WorkFlowManagerDB; User Id=sa; Password=123456; MultipleActiveResultSets=True; Integrated Security = false")    
        {
